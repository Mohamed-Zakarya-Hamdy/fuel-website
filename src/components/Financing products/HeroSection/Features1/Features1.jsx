...
function Features1() {
  const features = [
    ...
    { id: 4, text: "مجموعة واسعة من الشركاء في قطاعات مختلفة", icon: "/icons/Asset 16 1.png" },
    { id: 5, text: "متوافق مع ضوابط وأحكام الشريعة الإسلامية", icon: "/icons/Asset 15 1.png" },
  ];
